...
export const Route = createFileRoute("/student/notifications")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Application updates, assessment results and new opportunity alerts in one place.",
      },
      { property: "og:title", content: "Notifications | SkillBridge" },
      { property: "og:description", content: "Your SkillBridge alerts: applications, assessments and opportunities." },
...
function StudentNotificationsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeading
        title="Notifications"
        description="Application updates, assessment results and new opportunities."
        actions={
          unread.length ? (
      ...
      {visible.length === 0 ? (
        <EmptyState
          ...
          description="We'll let you know when a recruiter moves your application or a matching role opens."
        />
      ) : (
