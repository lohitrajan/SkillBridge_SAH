...
export const Route = createFileRoute("/recruiter/notifications")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Stay on top of applications, invites and platform updates on SkillBridge." },
      { property: "og:title", content: "Notifications | SkillBridge" },
      { property: "og:description", content: "Your SkillBridge recruiter alerts, in one place." },
...
function RecruiterNotificationsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeading
        title="Notifications"
        description="Applications, invites and platform updates."
        actions={
          unread.length ? (
      ...
      {visible.length === 0 ? (
        <EmptyState
          ...
          description="We'll let you know when students apply or your postings need attention."
        />
      ) : (
